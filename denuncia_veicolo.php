...
<head>
    ...
    $search_progressive = "SELECT id FROM denuncia_veicolo ORDER BY id DESC LIMIT 1";
...
<body style="background-color: rgb(9,0,44);">
    <div class="table-responsive">
        <form method="POST" action="./action/add_denuncia_veicolo.php">
            <table class="table">
                <thead>
                    <tr>
                    ...
                    <?php
                            if($isInserted == 1){
                                echo "<tr>";
                                echo '<div class="alert alert-success" align="center"> <b>Denuncia veicolo Aggiunta</b> </div>';
                                echo "</tr>";
                            }
                    ?>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="color: rgb(255,255,255);"></td>
                        <td class="text-center" style="color: rgb(255,255,255);">Progressivo&nbsp; &nbsp;&nbsp;<input type="text" value="<?php echo($retrieve_new_id); ?>" name="progressivo_den" disabled></td>
                    </tr>
                    <tr>
                        <td class="text-center" style="color: rgb(255,255,255);"></td>
